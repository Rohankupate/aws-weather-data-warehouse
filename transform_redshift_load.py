...
transform_task = GlueJobOperator(
    ...
    script_location='s3://etls3glueredshift/scripts/transform.py',
    s3_bucket='etls3glueredshift',  # S3 bucket where logs and local etl script will be uploaded
    aws_conn_id='AWS_CONN',  # You'll need to set up an AWS connection in Airflow
    region_name="us-east-2",
    iam_role_name='',
    create_job_kwargs ={"GlueVersion": "4.0", "NumberOfWorkers": 3, "WorkerType": "G.1X", "Connections":{"Connections":["redshift-demo-connection"]},},
    dag=dag,
)
